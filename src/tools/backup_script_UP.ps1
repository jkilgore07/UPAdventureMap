...
$repoPath = "C:\Users\jerom\CascadeProjects\UPAdventureMap"
$backupBasePath = "D:\Backups\UP_Trip"
...
foreach ($file in $filesToCopy) {
    ...
    # Show progress bar
    Write-Progress -Activity "Backing up UP Trip" -Status "$percentComplete% Complete" -PercentComplete $percentComplete -CurrentOperation "Copying: $relativePath" -Id 1
}

# Complete the progress bar
Write-Progress -Activity "Backing up UP Trip" -Completed -Id 1
